...
available for this repository. If private reporting is unavailable, open a
minimal GitHub issue requesting a private contact channel. Do not include an
...
The source is available for inspection under the proprietary terms in
[LICENSE](LICENSE). Security review does not grant permission to modify,
compile, or redistribute the source.

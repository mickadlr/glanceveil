...
- `listing.md` contains product and reviewer copy.
- `privacy-fields.md` contains the single-purpose statement, permission
  justifications, and local-data disclosures.
- `assets/promo-small-440x280.png` is the required small promotional image.
- `assets/screenshot-01-page-and-controls-1280x800.png` and
  `assets/screenshot-02-setup-1280x800.png` are store screenshots.
